...
const QuickNavbar = () => {
  ...
  return (
    <div className="mb-10">
      <div className="navbar-containers fixed top-0 left-0 w-full z-50 bg-white shadow-md p-2 flex items-center justify-between border">
        <div className="flex items-center ">
          <img
            src={logo}
            alt="Logo"
            className="w-15 h-14 rounded-full navbar-logo-for-the-quick-navbar-nav"
          />
        ...
        <div className="flex items-center gap-3 quicknav-header-righ-section-with-home-name-and-btns">
          ...
          {/* <li> */}
          <Link
            to="https://internsbee.com"
            className="text-black hover:text-black text-lg font-bold  quicknav-header-righ-section"
          >
            Home
          </Link>
          {/* </li> */}
