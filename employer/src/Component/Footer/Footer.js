...
const Footer = () => {
    ...
    return (
        <>
            <footer className="MainFooter h-400 text-black p-6 flex justify-evenly items-center footer-resopnsive shadow-md"style={{ backgroundColor: '#FFBD59' }}>
                ...
                <div className="flex gap-14  flex-row  ml-20 footer-content">
