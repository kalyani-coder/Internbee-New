                ...
                <div className="container px-5 py-5 mx-auto ">
                    ...
                    {monthlyPackage && (
                        <div className="w-full md:w-1/2 mx-auto">
                            <div className="Freecard p-4 xl:w-full md:w-1/2 w-full">
                                <div className="Freecard h-full p-6 rounded-lg flex flex-col relative overflow-hidden">
                                    <div className="Freecard p-4 w-full">
                                        <div className="Freecards h-full p-6 rounded-lg border-2 border-amber-300 flex flex-col relative overflow-hidden">
                                            ...
                                            <p className="flex items-center text-black mb-2">                   <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-amber-300 text-white rounded-full flex-shrink-0">
                                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                                                    <path d="M20 6L9 17l-5-5"></path>
                                                </svg>
                                            ...
                                            <p className="flex items-center text-black mb-6">
                                                <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-amber-300 text-white rounded-full flex-shrink-0">                     <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                                                    <path d="M20 6L9 17l-5-5"></path>
                                                </svg>
