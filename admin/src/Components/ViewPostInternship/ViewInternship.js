            ...
            <div className="flex h-screen">
                ...
                <div className="ml-10 mt-4">
                    <div className="max-w-full p-4">
                        <h1 className="text-3xl font-bold mb-4 mt-8">View Internship Details</h1>
                        ...
                        <table className="w-full bg-white border border-gray-300">
                            <thead>
                                <tr>
                                    ...
                                    <th className="py-4 px-6 border-b font-bold text-lg">EmployerName</th>
                                    <th className="py-4 px-6 border-b font-bold text-lg">View More</th>
