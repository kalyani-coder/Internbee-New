...
const AdminDashboard = () => {
  ...
  const generateExcel = async () => {
    ...
    const jobPostingsResponse = await fetch('https://backend.internsbee.com/api/postinternship');
    const jobPostingsData = await jobPostingsResponse.json();

    // Fetch data for applied students from your API
    const appliedStudentsResponse = await fetch('https://backend.internsbee.com/api/applyInternship');
    const appliedStudentsData = await appliedStudentsResponse.json();

    // Fetch data for shortlisted candidates from your API
    const shortlistedCandidatesResponse = await fetch('https://backend.internsbee.com/api/applyInternship/shortlisted');
    const shortlistedCandidatesData = await shortlistedCandidatesResponse.json();
    ...
    data.push({ Category: "Total Applied Students", Count: appliedCandidatesCount }); // Add count for applied students
    ...
    data.push({ Category: "Total Shortlisted Candidates", Count: shortlistedCandidatesCount }); // Add count for shortlisted candidates
