...
const StudentSubscriptionFree = () => {
  ...
  const savePackage = async () => {
      try {
          const response = await fetch(`https://backend.internsbee.com/api/students/students-free-package/${monthlyPackage._id}`, {
              method: 'PATCH',
              headers: {
                  'Content-Type': 'application/json',
              },
              body: JSON.stringify({
                freePackagePrice: editedPackage.freePackagePrice,
      ...
      <div className="w-full md:w-1/2 mx-auto">
        <div className="p-4 xl:w-full md:w-1/2 w-full">
          <div className="h-full p-6 rounded-lg border-2 border-amber-300 flex flex-col relative overflow-hidden">
            ...
            <h2 className="text-sm tracking-widest title-font mb-1 font-medium">FREEMIUM</h2>
      ...
      {isModalOpen && (
                <div className="fixed inset-0 bg-gray-700 bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white p-8 max-w-md w-full rounded-md">
                        ...
                        <input
                            type="text"
                            name="freePackagePrice"
                            value={editedPackage.freePackagePrice}
...
export default StudentSubscriptionFree