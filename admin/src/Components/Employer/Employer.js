              ...
              <table className="w-full bg-white border border-gray-300">
                <thead>
                  <tr>
                    ...
                    <th className=" TableHeading py-4 px-6 border-b font-bold text-lg">Employers Name</th>
                    <th className="TableHeading py-4 px-6 border-b font-bold text-lg">Email</th>
                    <th className="TableHeading py-4 px-6 border-b font-bold text-lg">Contact No.</th>
